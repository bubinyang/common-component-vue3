      ...
      <ContainLayout>
        ...
        <template #contain>
          <el-table
            ...
            height="100%"
          >
            <el-table-column prop="name" label="公差上限" align="center"> </el-table-column>
            <el-table-column prop="name" label="公差下限" align="center"> </el-table-column>
            <el-table-column prop="name" label="预警上限" align="center"> </el-table-column>
            <el-table-column prop="name" label="预警下限" align="center"> </el-table-column>
