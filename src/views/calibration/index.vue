      ...
      <ContainLayout>
        ...
        <template #contain>
          ...
          >
            ...
            <el-table-column prop="name" label="传感器值" align="center"> </el-table-column>
            <el-table-column prop="name" label="大校准值" align="center"> </el-table-column>
            <el-table-column prop="name" label="小校准值" align="center"> </el-table-column>
